...
public class Jasper {
    ...
    public static void main(String[] args) {
       ...
       for (String arg : args) {
        ...
        for (int i = 0; i < classList.size(); i++) {
            ...
            String fileName = classList.elementAt(i);
    ...
    /*-----------------------------------------------------------------------
     ...
     -----------------------------------------------------------------------*/
    static void recurseClasses(ClassFile cls, Vector<String> classList) {
       ...
       for (String[] strings : newClassRef) {
          for (String string : strings) {
             // kill the field access permission attributes
             newClass = stripAccess(string);
    ...
    /*-----------------------------------------------------------------------
     ...
     -----------------------------------------------------------------------*/
    static void addClassFile(String name, Vector<String> classList) {
        ...
        for (int i = 0; i < classList.size(); i++) {
            if (classList.elementAt(i).equals(fileName)) return;
        }
    ...
    static void browseDump(ClassFile cls) {
        ...
        for (String s : ix) System.out.println("   implements = " + s);
        for (String s : fx) System.out.println("   field      = " + s);

 ...
 *             Because it is used outside its source file, it should be defined
...
class Attribute_Collection {
    /*-----------------------------------------------------------------------
     ...
     -----------------------------------------------------------------------*/
    private static final Object[][] dispatch = {
    ...
    private final int count;                  // number of attributes
    private final Attribute[] attributes;     // attributes declared in this section (field, class, or method)
        ...
        for (int i = 0; i < count; i++) {
            ...
            try {
                ...
                try {
                    ...
                    myConstructor = newClass.getConstructor(ios.getClass(), pool.getClass(), int.class);
    ...
    static Class<?> getDispatch(String s) {
        ...
        for (int i = 1; i < dispatch.length; i++) {
            if (s.equals(dispatch[i][0])) return (Class<?>) dispatch[i][1];
        }
    ...
    /*-----------------------------------------------------------------------
     - Method:        getLabel                                              -
     -                                                                      -
     - Desc:          ask attributes if they need any LABEL's to be printed  -
     -----------------------------------------------------------------------*/
    ...
    String jasminConstantValue() {
        ...
        for (int i = 0; i < count; i++) retVal.append(attributes[i].jasminConstantValue());
    ...
    String jasminSourceFile() {
        StringBuilder retVal = new StringBuilder();
        for (int i = 0; i < count; i++) retVal.append(attributes[i].jasminSourceFile());
        return retVal.toString();
    }
    ...
    String browseSourceFile() {
        StringBuilder retVal = new StringBuilder();
        for (int i = 0; i < count; i++) retVal.append(attributes[i].browseSourceFile());
        return retVal.toString();
    }
    ...
    String browseDeprecated() {
        StringBuilder retVal = new StringBuilder();
        for (int i = 0; i < count; i++) retVal.append(attributes[i].browseDeprecated());
        return retVal.toString();
    }
    ...
    String browseSynthetic() {
        StringBuilder retVal = new StringBuilder();
        for (int i = 0; i < count; i++) retVal.append(attributes[i].browseSynthetic());
        return retVal.toString();
    }
    ...
    String browseConstantValue() {
        StringBuilder retVal = new StringBuilder();
        for (int i = 0; i < count; i++) retVal.append(attributes[i].browseConstantValue());
        return retVal.toString();
    }
...
class Attribute_ConstantValue extends Attribute {
    private final int constantIndex;          // constant value (index into constant pool table)
...
class Attribute_Exceptions extends Attribute {
    private final int count;                  // number of exceptions which the method throws
    private final int[] exceptionIndex;       // name of the exception class (index into constant pool table)
...
class Attribute_InnerClasses extends Attribute {
    private final int count;                  // number of inner class entries
    private final int[] innerIndex;           // full class name of inner class
    private final int[] outerIndex;           // the class of which the inner class is a member (current = 0)
    private final int[] nameIndex;            // simple class name of the inner class (anynomous = 0)
    private final int[] accessFlags;          // access permissions for the inner class
...
class Attribute_LineNumberTable extends Attribute {
    private final int count;                  // number of entries in the table
    private final int[] pc;                   // program counter associated with the source line number
    private final int[] lineNum;              // line number in the java source file
...
class Attribute_LocalVariableTable extends Attribute {
    private final int count;                  // number of entries
    private final int[] startPC;              // program counter start for local variable
    private final int[] len;                  // length of local variable usage (relative to startPC)
    private final int[] nameIndex;            // name of the local variable (index into constant pool table)
    private final int[] descriptorIndex;      // type of the local variable (index into constant pool table)
    private final int[] varIndex;             // local variable table index in the java bytecode
...
class Attribute_SourceFile extends Attribute {
    private final int sourceIndex;            // source file name (index into the constant pool table)
...
class Attribute_Unknown extends Attribute {
    ...
    public Attribute_Unknown(DataInputStream ios, Pool_Collection pool, int attributeIndex) throws IOException {
        ...
        System.out.println("Undefined Attribute (length=" + length + ") (name=" + this + ")");
